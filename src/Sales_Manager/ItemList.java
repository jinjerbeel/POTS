...
public class ItemList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblItemList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Name", "Category", "Quantity", "Unit Price", "Supplier Id"
            }
        ));
    ...
    private void btnLoadDataActionPerformed(java.awt.event.ActionEvent evt) {                                            
        Item viewItems = new Item (tblItemList); // Pass the JTable to ViewItemsFrame
        viewItems.loadItemList(); // Call the method to load data from the text file
