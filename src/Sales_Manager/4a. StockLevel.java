...
public class StockLevel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblStockLevel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Item Name", "Current In Stock"
            }
        ));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(btnBacktoDashboard, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnLoadDataActionPerformed(java.awt.event.ActionEvent evt) {                                            
        Stock viewStocks = new Stock(tblStockLevel); // Pass the JTable to Stock class
        viewStocks.loadStockLevel();// TODO add your handling code here:
    }                                           
