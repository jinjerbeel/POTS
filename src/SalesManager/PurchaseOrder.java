...
public class PurchaseOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblPurchaseOrder.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PO ID", "REQ ID", "Date", "Supplier ID", "Supplier Name", "Item Code", "Item Name", "Quantity", "Unit Price", "Total Price", "Approved by"
            }
        ));
    ...
    private void btnLoadDataActionPerformed(java.awt.event.ActionEvent evt) {                                            
        PO viewPO = new PO(tblPurchaseOrder); 
        viewPO.loadPurchaseOrderList(); 
    }                                           
